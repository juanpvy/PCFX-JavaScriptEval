...
export class JavascriptEVAL implements ComponentFramework.StandardControl<IInputs, IOutputs> {

    private _inputElement : HTMLInputElement;   
    private _container: HTMLDivElement;
    private _controlViewRender:boolean;
    private _notifyOutputChanged:any;
    private _previusValue:string;
    ...
    public getOutputs(): IOutputs
    {
        ...
        return { FormulaResult:this._inputElement.value };
    }
